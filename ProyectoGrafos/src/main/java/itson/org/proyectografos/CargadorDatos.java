...
public class CargadorDatos {
    ...
    public static List<Localidad> cargarLocalidades() {
        ...
        lista.add(new Localidad("Comitán", 339, 281));           
        lista.add(new Localidad("Chiapa de Corzo", 267, 292));   
        lista.add(new Localidad("Palenque", 350, 450));          
        lista.add(new Localidad("Cintalapa", 400, 500));        
        lista.add(new Localidad("Ocosingo", 450, 550));          
        lista.add(new Localidad("Ocozocoautla", 500, 600));      
        lista.add(new Localidad("Tonalá", 550, 650));            
        lista.add(new Localidad("Villaflores", 600, 700));      
        lista.add(new Localidad("Berriozábal", 650, 750));      
        lista.add(new Localidad("Huixtla", 700, 800));           
        lista.add(new Localidad("Reforma", 750, 850));          
        lista.add(new Localidad("Motozintla", 800, 900));       
        lista.add(new Localidad("Arriaga", 850, 950));           
        lista.add(new Localidad("Las Margaritas", 900, 1000));  
        lista.add(new Localidad("Frontera Comalapa", 950, 1050));
        lista.add(new Localidad("Las Rosas", 1000, 1100));       
        lista.add(new Localidad("Teopisca", 1050, 1150));    
   ...
   public static List<Carretera> cargarCarreteras(List<Localidad> locs) {
       ...
       // Conexiones desde Tuxtla Gutiérrez (ID 0 en tu lista de Wikipedia)
       ...
       carreteras.add(new Carretera(locs.get(0), locs.get(8), 35.0));  // Tuxtla - Ocozocoautla
       carreteras.add(new Carretera(locs.get(0), locs.get(10), 75.0)); // Tuxtla - Villaflores

       // Conexiones desde San Cristóbal (ID 2)
       ...
       carreteras.add(new Carretera(locs.get(2), locs.get(18), 50.0)); // San Cristóbal - Las Rosas

       // Conexiones zona Comitán (ID 3)
       ...
       carreteras.add(new Carretera(locs.get(13), locs.get(15), 85.0)); // Reforma - Pichucalco (aprox)
